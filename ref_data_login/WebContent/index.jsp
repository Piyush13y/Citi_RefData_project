...
<div class="cotn_principal">
 	<div class="cont_centrar">
 		...
 		<div class="cont_login">
    		<div><p align="center" id="message"><%  if(session.getAttribute("message")!=null) {out.println(session.getAttribute("message")+"<br> Please login to continue!"); session.invalidate();} %></p><br></div>
